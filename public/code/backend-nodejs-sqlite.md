...
Generated on: 2025-11-16T21:11:14.769Z
...
DB_NAME=franchise_india.sqlite
...
const dbPath = path.join(dataDir, process.env.DB_NAME || 'franchise_india.sqlite');
...
export const logError = (error: Error, context?: any): void => {
  console.error('[ERROR]', context?.context || 'Error:', error.message);
